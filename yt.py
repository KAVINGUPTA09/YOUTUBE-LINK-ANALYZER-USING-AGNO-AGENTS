...
def build_youtube_agent():
    return Agent(
        ...
        tools=[], # Keeping tools empty to handle scraping inside native python code instead
        instructions=dedent("""\
            You are an expert YouTube content analyst with a keen eye for detail! 🎓
            Analyze the provided video details and text context systematically using these steps:
            
            1. Video Overview
            - Identify video type based on the title/metadata or transcript style (tutorial, review, gaming highlights, lecture, etc.)
            ...
            - If the context indicates the video has no voice track/spoken text (e.g. gameplay compilation, music video), outline the expected highlights based on the video data.
